	...
	return (
		<div className={styles.container}>
			...
			<Helmet>
				...
				/>
				<link rel="canonical" href="https://www.marvelpartners.co.kr/BusinessGuide/intro" />
				...
				<meta
					...
					content="힐스테이트 도안리버파크의 사업개요를 통해 프로젝트의 비전과 가치를 확인하세요. 단지 설계, 개발 목표, 주변 환경과의 조화 등을 중점적으로 설명하여 평택에서의 새로운 주거 중심지로서의 가능성을 보여드립니다."
				/>
				<meta property="og:image" content="https://www.marvelpartners.co.kr/Main1.png" />
				<meta property="og:url" content="https://www.marvelpartners.co.kr/BusinessGuide/intro" />
				...
				<meta
					...
					content="힐스테이트 도안리버파크의 사업개요를 통해 프로젝트의 비전과 가치를 확인하세요. 단지 설계, 개발 목표, 주변 환경과의 조화 등을 중점적으로 설명하여 평택에서의 새로운 주거 중심지로서의 가능성을 보여드립니다."
				/>
				<meta name="twitter:image" content="https://www.marvelpartners.co.kr/Main1.png" />
				<meta name="twitter:url" content="https://www.marvelpartners.co.kr/BusinessGuide/intro" />
				...
				<script type="application/ld+json">
					{`
					{
						...
						"url": "https://www.marvelpartners.co.kr/BusinessGuide/intro"
					}
					`}
				</script>
			</Helmet>
