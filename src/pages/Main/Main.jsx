    ...
    <button type="submit">등록하기</button>
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.container7}>
            ...
            <img
              src={section8Img3}
              alt="힐스테이트 도안리버파크 mobile입지안내-image1"
            />
          </div>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 힐스테이트 도안리버파크 <br />
                모델하우스에서 확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="힐스테이트 도안리버파크 mobile조감도-image1"
            />
          </div>
          ...
          <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="힐스테이트 도안리버파크 브랜드소개 mobile-image5"
              />
