  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://www.apay.co.kr/SalesInfo/SubscriptionGuide"
        />
        ...
        <meta
          property="og:url"
          content="https://www.apay.co.kr/SalesInfo/SubscriptionGuide"
        />
        ...
        <script type="application/ld+json">
          {`	{		"@context": "https://schema.org",		"@type": "WebPage",		"name": "힐스테이트 도안리버파크 - 체크포인트",		"description": "힐스테이트 도안리버파크분양 전 필수 체크포인트를 확인하세요. 청약 자격, 서류 준비, 일정 등 분양 절차에서 놓치지 말아야 할 중요한 사항들을 정리해두었습니다. 정확한 정보와 절차를 통해 분양을 성공적으로 진행할 수 있도록 돕습니다.",		"url": "https://www.apay.co.kr/SalesInfo/SubscriptionGuide"	}	`}
        </script>
      </Helmet>
